...
namespace StajKariyerWeb.Migrations
{
    ...
    [Migration("20260514151831_AddApplicationUserIdToCompanyProfile")]
    partial class AddApplicationUserIdToCompanyProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StajKariyerWeb.Models.JobApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StajKariyerWeb.Models.CompanyProfile", b =>
                {
                    b.HasOne("StajKariyerWeb.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("StajKariyerWeb.Models.JobApplication", b =>
                {
                    b.HasOne("StajKariyerWeb.Models.CompanyProfile", "CompanyProfile")
                        .WithMany()
                        .HasForeignKey("CompanyProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StajKariyerWeb.Models.ApplicationUser", "Student")
                        .WithMany()
